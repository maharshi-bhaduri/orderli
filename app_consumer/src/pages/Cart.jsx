        ...
        <div className="bg-orange-300 bg-cover bg-center pt-2 px-2 h-screen">
            <div className="text-black w-full flex flex-col items-center justify-center">
              ...
              rounded-lg bg-white hover:bg-gray-300 transition ease-in-out"
                        ...
                        <h2 className="text-xl font-bold flex items-center">Cart</h2>
                        <button
                            ...
                            cartItems.length === 0 ?
                                ...
                                : (cartItems.map(({ itemDetails, quantity }) => (
                                    ...
                                    >
                                        {/* Item Name */}
                                        <div>
                                            <h3 className="font-semibold">{itemDetails.itemName}</h3>
                                        </div>
                                        ...
                                        <div className="flex items-center justify-center">
                                            ...
                                            <div className="px-3 py-1 bg-gray-200 text-md w-10 flex justify-center">{quantity}</div>
                                            <button
                                                onClick={() => handleAdd(itemDetails.menuId, itemDetails)}
